...
packagelist <- c('bookdown','pals','pracma','shape','reshape2','diagram','devtools')
...
nsims <- 1000  # global value for the whole script - increase to 100000 for final run, but note this takes around 16 hours to complete (depending on processor speed)
...
points(actualslog,tsqpropM[,vinds[n]],lwd=3,pch=15,cex=1.5,col=nbdtpal[1])
