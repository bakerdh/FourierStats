...
Note that a two-sample independent Hotelling's $T^2$ test is included in the _Hotelling_ package (_hotelling.test_ function). A repeated measures (paired) test can be conducted by subtracting the conditions and running a one-sample test (this is mathematically equivalent).
